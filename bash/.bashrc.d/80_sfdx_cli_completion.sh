...
force:mdapi:convert --json --loglevel --rootdir --outputdir --manifest --metadatapath --metadata
force:mdapi:beta:convert --json --loglevel --rootdir --outputdir --manifest --metadatapath --metadata
force:mdapi:deploy --json --loglevel --targetusername --apiversion --checkonly --deploydir --wait --testlevel --runtests --ignoreerrors --ignorewarnings --validateddeployrequestid --verbose --zipfile --singlepackage --soapdeploy --purgeondelete --concise --resultsdir --coverageformatters --junit
force:mdapi:beta:deploy --json --loglevel --targetusername --apiversion --checkonly --deploydir --wait --testlevel --runtests --ignoreerrors --ignorewarnings --validateddeployrequestid --verbose --zipfile --singlepackage --soapdeploy --purgeondelete --concise --resultsdir --coverageformatters --junit
force:mdapi:deploy:cancel --json --loglevel --targetusername --apiversion --wait --jobid
force:mdapi:deploy:report --json --loglevel --targetusername --apiversion --wait --jobid --verbose --concise --resultsdir --coverageformatters --junit
force:mdapi:beta:deploy:report --json --loglevel --targetusername --apiversion --wait --jobid --verbose --concise --resultsdir --coverageformatters --junit
force:mdapi:retrieve --json --loglevel --targetusername --apiversion --retrievetargetdir --unpackaged --sourcedir --packagenames --singlepackage --zipfilename --unzip --wait --verbose
force:mdapi:beta:retrieve --json --loglevel --targetusername --apiversion --retrievetargetdir --unpackaged --sourcedir --packagenames --singlepackage --zipfilename --unzip --wait --verbose
force:mdapi:retrieve:report --json --loglevel --targetusername --apiversion --retrievetargetdir --jobid --zipfilename --unzip --wait --verbose
force:mdapi:beta:retrieve:report --json --loglevel --targetusername --apiversion --retrievetargetdir --jobid --zipfilename --unzip --wait --verbose
force:source:convert --json --loglevel --rootdir --outputdir --packagename --manifest --sourcepath --metadata
force:source:delete --json --loglevel --targetusername --apiversion --checkonly --wait --testlevel --noprompt --metadata --sourcepath --tracksource --forceoverwrite --verbose
force:source:deploy --json --loglevel --targetusername --apiversion --checkonly --soapdeploy --wait --testlevel --runtests --ignoreerrors --ignorewarnings --purgeondelete --validateddeployrequestid --verbose --metadata --sourcepath --manifest --predestructivechanges --postdestructivechanges --tracksource --forceoverwrite --resultsdir --coverageformatters --junit
force:source:deploy:cancel --json --loglevel --targetusername --apiversion --wait --jobid
force:source:deploy:report --json --loglevel --targetusername --apiversion --wait --jobid --verbose --resultsdir --coverageformatters --junit
force:source:ignored:list --json --loglevel --sourcepath
force:source:manifest:create --json --loglevel --apiversion --metadata --sourcepath --manifestname --manifesttype --includepackages --fromorg --outputdir
force:source:pull --json --loglevel --targetusername --apiversion --forceoverwrite --wait
force:source:beta:pull --json --loglevel --targetusername --apiversion --forceoverwrite --wait
force:source:push --json --loglevel --targetusername --apiversion --forceoverwrite --wait --ignorewarnings --quiet
force:source:beta:push --json --loglevel --targetusername --apiversion --forceoverwrite --wait --ignorewarnings --quiet
force:source:retrieve --json --loglevel --targetusername --apiversion --retrievetargetdir --sourcepath --wait --manifest --metadata --packagenames --tracksource --forceoverwrite --verbose
force:source:status --json --loglevel --targetusername --apiversion --local --remote --concise
force:source:beta:status --json --loglevel --targetusername --apiversion --local --remote --concise
force:source:tracking:clear --json --loglevel --targetusername --apiversion --noprompt
force:source:beta:tracking:clear --json --loglevel --targetusername --apiversion --noprompt
force:source:tracking:reset --json --loglevel --targetusername --apiversion --revision --noprompt
force:source:beta:tracking:reset --json --loglevel --targetusername --apiversion --revision --noprompt
...
complete -F _sfdx_autocomplete sfdx
