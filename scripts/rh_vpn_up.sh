...
echo -e "Bringing up Red Hat VPN connection and renewing Kerberos ticket"
...
echo -e "vpn.secrets.password:${PIN}${OTP}" > ${KEY_TMPFILE}
#nmcli connection up Red_Hat_Global_VPN passwd-file ${KEY_TMPFILE}
#nmcli connection up Amsterdam-VPN passwd-file ${KEY_TMPFILE}
nmcli connection up Red\ Hat\ Global\ VPN\ \(TCP\) passwd-file ${KEY_TMPFILE}
